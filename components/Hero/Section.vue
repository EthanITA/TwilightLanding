<template>
  <div class="relative isolate flex-1 px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-28 text-center sm:py-32 lg:py-48">
      <HeroHeading />
      <HeroSubheading />
      <CTAButton />
    </div>
    ...
    >
      <div
        class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-primary-500 to-secondary opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
        style="
          clip-path: polygon(
            74.1% 44.1%,
            100% 61.6%,
